...
<body>
<h4>
    <b>当前位置:资源管理>>设备管理>>ip设备升级</b>
</h4>
<div class="content">
    <div class="handle">
<%--        <button class="Upgrade btn btn-info">升级</button>--%>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body col-sm-12">
                <form id="form_updatefile" class="form-inline">
                   <input type="hidden" name="fIpOrTs" value="0"/>
                   <div class="content_left col-sm-8">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="form-control" data-validate="required" style="width:80%!important"
                                    ...
                                    <c:forEach items="${terminalDeviceList}" var="terminalDevice">
                                        <option value="${terminalDevice.fId}"
                                                <c:if test="selected='selected'">selected</c:if>>
                        ...
                        <div class="form-group col-sm-12">
                            <label class="col-sm-4 control-label">软件版本号</label>
                            <div class="col-sm-8">
                                <input name="fSoftwareVersion" type="text" class="form-control ">
                                <input name="fOldSoftwareVersion" type="hidden" class="form-control ">
                            </div>
                        </div>
                        <div class="form-group col-sm-12">
...
<script type="text/javascript">
    ...
    $(".modal").on("click", ".add_updatefile", function () {
        ...
        $('input[name="fOldSoftwareVersion"]').val(fileMD5);
        ...
        if (flag&&!checkname) {
            layer.confirm('是否确定新增？', {
                ...
                btn: ['确定', '取消'] //按钮
                    ...
                    $.ajax({
                        url: "${ctx}/resourceManage/updateFile/addUpdateFile",
                        type: 'post',
                        data:$("#form_updatefile").serialize()+"&fFileName="+fileName,
                        success: function (data) {
                            layer.msg(data.msg, {icon: 1});
    ...
    $(function () {
        $('#tab_updateFile').bootstrapTable({
            url: "${ctx}/resourceManage/updateFile/selectUpdateFile",
            method: 'post',
