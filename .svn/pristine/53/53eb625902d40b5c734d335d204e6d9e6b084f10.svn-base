 ...
 */
public class ColumnSettingCmd extends ConfigureCmd {
    ...
    /**
     * 
     * @param AddrType 要设置的终端编号的地址类型 1: 表示逻辑地址 2：表示物理地址 3~9：保留
     * @param AddrList 应急广播终端编码列表(物理码或资源编码)
     */
    ...
    public ColumnSettingCmd() {
        this.configureCmdTag = ConfigureCmd.CmdTag.ColumnSetting;
    }
