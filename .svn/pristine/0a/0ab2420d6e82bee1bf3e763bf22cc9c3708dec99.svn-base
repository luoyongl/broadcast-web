...
public class BVideoAds implements Serializable {
    private Integer fId;
    ...
    public void setfVideoName(String fVideoName) {
        this.fVideoName = fVideoName == null ? null : fVideoName.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        BVideoAds other = (BVideoAds) that;
        return (this.getfId() == null ? other.getfId() == null : this.getfId().equals(other.getfId()))
            && (this.getfVideoName() == null ? other.getfVideoName() == null : this.getfVideoName().equals(other.getfVideoName()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getfVideoName() == null) ? 0 : getfVideoName().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", fVideoName=").append(fVideoName);
