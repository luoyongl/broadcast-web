...
public class JPushBusinessUtil {
    protected static final Logger LOG = LoggerFactory.getLogger(JPushBusinessUtil.class);

    // demo App defined in resources/jpush-api.conf 
    protected static final String APP_KEY ="f58bd6c95f225b8cd8edb98a";
    protected static final String MASTER_SECRET = "d36995559ede49faf59bc0b4";
...
//        sendPushWithCallback(payload);
    ...
    public static void main(String[] args) {
        JPushBusinessUtil JPushService = new JPushBusinessUtil();
