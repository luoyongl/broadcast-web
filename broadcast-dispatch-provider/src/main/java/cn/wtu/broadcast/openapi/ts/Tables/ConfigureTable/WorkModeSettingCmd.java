 ...
 */
public class WorkModeSettingCmd extends ConfigureCmd {

    private final ConfigureCmd.CmdTag configureCmdTag;

    /**
     * 1:主机全断电 2：待机 3：应急唤醒 4~9：保留
     */
    public byte Terminal_wordmode;
    ...
    public WorkModeSettingCmd() {
        this.configureCmdTag = CmdTag.TerminalworkmodeSetting;
    }
