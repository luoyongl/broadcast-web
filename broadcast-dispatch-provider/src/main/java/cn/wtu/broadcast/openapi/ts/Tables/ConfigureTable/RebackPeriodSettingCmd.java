 ...
 */
public class RebackPeriodSettingCmd extends ConfigureCmd {
   ...
   public void setTermialAddress(byte AddrType, List<String> AddrList) {
        ...
        for (String s : AddrList) {
           ...
           // byte[] buf = Tools.StrToBCDBytes(s);
    ...
    public RebackPeriodSettingCmd() {
        this.configureCmdTag = ConfigureCmd.CmdTag.RebackPeriodSetting;
    }
